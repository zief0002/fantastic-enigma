...
- [[CSV]](https://raw.githubusercontent.com/zief0002/fantastic-enigma/main/data/scoobydoo.csv)
- [[Data Codebook]](https://zief0002.github.io/fantastic-enigma/codebooks/scoobydoo.html)
...
8. Create a visualization to show the adjusted mean engagement levels for different members of Mystery Inc that caught the villain. This visualization should mimic that of [Figure 19.7 in the textbook](https://zief0002.github.io/modeling/05-02-polychotomous-predictors.html#fig-mult-comp-4). (This should be based on the unadjusted *p*-values.) Feel free to use any software tool you want to create this visualization.
