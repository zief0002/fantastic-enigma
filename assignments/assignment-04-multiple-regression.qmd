...
- [[CSV]](https://raw.githubusercontent.com/zief0002/fantastic-enigma/main/data/fertility.csv)
- [[Data Codebook]](https://zief0002.github.io/fantastic-enigma/codebooks/fertility.html)
...
4. Indicate whether the two covariates are actually confounders by indicating whether the size and direction of the effect of contraceptive rate on fertility rate in Models 2--4  differs from that in Model 1. (Be sure to comment on both covariates.)
...
9. Interpret the estimated coefficient value associated with the partial effect of contraception.

10. Based on the 95% confidence interval for the partial effect of contraception on fertility rate, which parameter values are reasonably compatible with the empirical data? Explain what this implies about the magnitude of the partial effect. 
