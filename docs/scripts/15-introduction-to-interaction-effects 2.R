...
lm.f = lm(guilt ~ 1 + bound_span_work + female + married +
            bound_span_work:female + bound_span_work:married + female:married +
            bound_span_work:female:married, data = work)

tidy(lm.f)


lm.f = lm(guilt ~ 1 + bound_span_work + female + married + authority +
            bound_span_work:female + bound_span_work:married + bound_span_work:authority +
            female:married +
            authority:female + authority:married +
            bound_span_work:female:married + bound_span_work:female:authority +
            female:married:authority +
            bound_span_work:female:married:authority, data = work)
