...
The data in [scoobydoo.csv](https://raw.githubusercontent.com/zief0002/rustic-penguin/main/data/scoobydoo.csv) are a subset of data collected by [plummye](https://www.kaggle.com/williamschooleman) who "[t]ook ~1 year to watch every Scooby-Doo iteration and track every variable." There are 372 cases in the data.
